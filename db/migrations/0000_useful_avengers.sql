...
CREATE TYPE "public"."booking_status" AS ENUM('pending_payment', 'confirmed', 'assigned', 'completed', 'cancelled');--> statement-breakpoint
CREATE TYPE "public"."customer_type" AS ENUM('tourist', 'corporate');--> statement-breakpoint
...
CREATE TYPE "public"."route_category" AS ENUM('airport', 'intercity', 'city', 'corporate');--> statement-breakpoint
...
CREATE TABLE "customers" (
	...
	"customer_type" "customer_type" DEFAULT 'tourist' NOT NULL,
...
CREATE TABLE "routes" (
	...
	"currency" char(3) DEFAULT 'NAD' NOT NULL,
	"default_driver_payout" numeric(10, 2) NOT NULL,
...
CREATE INDEX "bookings_route_idx" ON "bookings" USING btree ("route_id");--> statement-breakpoint
...
CREATE INDEX "routes_category_idx" ON "routes" USING btree ("category");--> statement-breakpoint
