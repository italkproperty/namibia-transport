  ...
  const faqs: Faq[] = [
    {
      ...
      answer: `${price} for the whole vehicle in a private car. The price is fixed when you book — there is no meter, no surge pricing and no airport surcharge. A larger SUV or 4x4 is available at a higher fixed rate.`,
    },
    {
